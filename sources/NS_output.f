...
C   ========================
     ...
     ._40 c    sb)'
      ...
      if(brnupdb(1,5).ne.0.D0) then
       write(nout,104) brnupdb(1,5),3,in5,ic,isb,     'BR(~chi_1+ -> ~ch
     .i_50 c    sb)'
       endif
       if(brntopbb(1,1).ne.0.D0) then
       write(nout,104) brntopbb(1,1),3,in1,it,ibb,    'BR(~chi_1+ -> ~ch
     .i_10 t    bb)'
       endif
       if(brntopbb(1,2).ne.0.D0) then
       write(nout,104) brntopbb(1,2),3,in2,it,ibb,    'BR(~chi_1+ -> ~ch
     .i_20 t    bb)'
      endif
...
c ------------- c
     ...
     . W-)'
      ...
      write(nout,102) brstau2H(1),2,istau1,ihH1,     'BR(~tau_2 -> ~tau_
     .1 H_1)'
      endif
      if(brstau2H(2).ne.0.D0) then
      write(nout,102) brstau2H(2),2,istau1,ihH2,     'BR(~tau_2 -> ~tau_
     .1 H_2)'
      endif
      if(brstau2H(3).ne.0.D0) then
      write(nout,102) brstau2H(3),2,istau1,ihH3,     'BR(~tau_2 -> ~tau_
     .1 H_3)'
      endif
      if(brstau2A(1).ne.0.D0) then
      write(nout,102) brstau2A(1),2,istau1,ihA1,     'BR(~tau_2 -> ~tau_
     .1 A_1)'
      endif
      if(brstau2A(2).ne.0.D0) then
      write(nout,102) brstau2A(2),2,istau1,ihA2,     'BR(~tau_2 -> ~tau_
     .1 A_2)'
      endif
