...
* - if MAFLAG = 0: AL at Q2 is given in PAR(5), XIF at Q2 is
*   given, MA at QSTSB is computed here and stored in PAR(23)
* - if MAFLAG = 1: MA at QSTSB is given in PAR(23), XIF at Q2
*   is given, AL at Q2 is computed here and stored in PAR(5)
* - AK at Q2 is given in PAR(6), XIS at Q2 is
...
*******************************************************************
      ...
      DOUBLE PRECISION At,Tad,f,mSing2,yy,vv,majS
...
*****************************************************************	  
*     MUeff in the Minimal Composite Model
