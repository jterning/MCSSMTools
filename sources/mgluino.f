...
*  plus possible shift to MSbar
      ...
      DMG= 3d0*(2d0*B0(MGL2,MGL2,0d0,Q2)-B1(MGL2,MGL2,0d0,Q2)
     .     -R/2d0)

*  quark-squark loops, eq.(D.44) of BMPZ

      DMQ= 2d0*(B1(MGL2,0d0,MUL**2,Q2) + B1(MGL2,0d0,MUR**2,Q2)
     .       + B1(MGL2,0d0,MDL**2,Q2) + B1(MGL2,0d0,MDR**2,Q2))
     .       + B1(MGL2,MT**2,MST1**2,Q2) + B1(MGL2,MT**2,MST2**2,Q2)
     .       + B1(MGL2,MB**2,MSB1**2,Q2) + B1(MGL2,MB**2,MSB2**2,Q2)
     .       + MT/MGL*S2T*(B0(MGL2,MT**2,MST1**2,Q2)
     .       + B0(MGL2,MT**2,MST2**2,Q2))
     .       + MB/MGL*S2B*(B0(MGL2,MB**2,MSB1**2,Q2)
     .       + B0(MGL2,MB**2,MSB2**2,Q2))
