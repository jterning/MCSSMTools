...
{ int l,i;
  ...
  { checkNaN=1;
    ...
    {  
      if(strcmp(name,"printf")==0) tp='N';
      else if(strcmp(name,"slhaRead")==0)
      { 
        fprintf(ext_h, " extern int %s(",name);
        fprintf(ext_h, " char *);\n");
        tp='N';
      }
      else if(strcmp(name,"slhaVal")==0)
      {
        fprintf(ext_h, " extern double %s(",name);
        fprintf(ext_h,"char *, double,int, ...);\n");
      }
      else if(strcmp(name,"slhaValExists")==0)
      {
        fprintf(ext_h, " extern int %s(",name);
        fprintf(ext_h,"char *, int, ...);\n");
        tp='N';
      }
      else if(strcmp(name,"rDiagonal")==0)
      {
        fprintf(ext_h, " extern int %s(",name);
        fprintf(ext_h,"int, int, ...);\n");
        tp='N';
      }
      else if(strcmp(name,"rDiagonal2")==0)
      {
        fprintf(ext_h, " extern int %s(",name);
        fprintf(ext_h,"int, int, ...);\n"); 
        tp='N';      
      }
      else if(strcmp(name,"MassArray")==0)
      {
        fprintf(ext_h, " extern double %s(",name);
        fprintf(ext_h,"int, int);\n");
      }
      else if(strcmp(name,"MixMatrix")==0)
      {
        fprintf(ext_h, " extern double %s(",name);
        fprintf(ext_h,"int,int,int);\n");
      }      
      else if(strcmp(name,"MixMatrixU")==0)
      {
        fprintf(ext_h, " extern double %s(",name);
        fprintf(ext_h,"int, int,int);\n");
      }      
