...
************************************************************************
      ...
      INTEGER IFAIL,I,ITER,ITERMU,MUFLAG,SFFLAG,Q2FIX,IM
      INTEGER OMGFLAG,MAFLAG,NMSFLAG,NMSCAN

      DOUBLE PRECISION PAR(NPAR),PROB(NPROB),CHECK,GUTEST,DELMB
      DOUBLE PRECISION DETM,R,K,MUFAIL,MUSTEP,MUINIT,MSMOY,MSTOT
      DOUBLE PRECISION M0,M12,A0,SIGMU,Q2,Q2MIN
...
*   Set default values
      ...
      IF(M1INP.EQ.1d99)M1INP=M12
      IF(M2INP.EQ.1d99)M2INP=M12
      IF(M3INP.EQ.1d99)M3INP=M12
      IF(MHDINP.EQ.1d99)MHDINP=M0**2
      IF(MHUINP.EQ.1d99)MHUINP=M0**2
      IF(ALINP.EQ.1d99)ALINP=A0
      IF(AKINP.EQ.1d99)AKINP=A0
...
*********************************************************************      
     ...
     . MQGUT,MUGUT,MDGUT,ML3GUT,ME3GUT,MLGUT,MEGUT
      ...
      !CALL PRINTMASSES(6,0)
      !CALL HIGGSMASSES(6)
      !CALL DECAY2INFO('h1',6)
      !CALL DECAY2INFO('h2',6)
      !CALL DECAY2INFO('h3',6)
      !CALL DECAY2INFO('ha',6)
      !CALL DECAY2INFO('hb',6)
      !WRITE(0,*)""
      !WRITE(0,*)"Omega=",OMG,"  Xf=",Xf
      !WRITE(0,*)""
      !CALL O1CONTENTS(6)
      !WRITE(0,*)""
      !CALL PRINTCHANNELS(Xf,1.D-3,1.D-6,1,6)
      !WRITE(0,*)""
     ...
     . WRITE(17,900) 4,"# No electroweak symmetry breaking"
      ...
      IF(M1INP.NE.M12)WRITE(17,901) 1,M1INP,"M1 AT THE GUT SCALE"
      IF(M2INP.NE.M12)WRITE(17,901) 2,M2INP,"M2 AT THE GUT SCALE"
      IF(M2INP.NE.M12)WRITE(17,901) 3,M3INP,"M3 AT THE GUT SCALE"
      IF(MHDINP.NE.M0**2)
     ...
     . WRITE(17,901) 22,MHUINP,"MHU^2 AT THE GUT SCALE"      
      ...
      IF(AKINP.NE.A0)WRITE(17,901) 64,AKINP,"AKAPPA AT THE GUT SCALE"
      IF(ALINP.NE.A0)WRITE(17,901) 65,ALINP,"ALAMBDA AT THE GUT SCALE"
      ...
      WRITE(17,901) 69,M3HINP,"M3H^2 AT THE GUT SCALE "
     ...
     .   "# Exp. 2 Sigma: 3.03E-04 < BR(b -> s gamma) < 4.01E-04:"
      WRITE(17,902) 1,BRSG,"BR(b -> s gamma)"
      WRITE(17,902) 11,BRSGMAX,"(BR(b -> s gamma)+Theor.Err.)"
      WRITE(17,902) 12,BRSGMIN,"(BR(b -> s gamma)-Theor.Err.)"
      WRITE(17,899) "# Exp. 2 Sigma: 4.99E-01 < Delta M_d < 5.15E-01:"
      WRITE(17,902) 2,DMD,"Delta M_d in ps^-1"
      WRITE(17,902) 21,DMdmax,"Delta M_d +Theor.Err."
      WRITE(17,902) 22,DMdmin,"Delta M_d -Theor.Err."
      WRITE(17,899) 
     .   "# Exp. 2 Sigma: 1.753E+01 < Delta Ms < 1.801E+01:"
      WRITE(17,902) 3,DMS,"Delta M_s in ps^-1"
      WRITE(17,902) 31,DMsmax,"Delta M_s +Theor.Err."
      WRITE(17,902) 32,DMsmin,"Delta M_s -Theor.Err."
      WRITE(17,899) "# Exp. 95% C.L.: BR(Bs->mu+mu-) < 1.1E-08:"
      WRITE(17,902) 4,BRBMUMU,"BR(Bs -> mu+mu-)"
      WRITE(17,902) 41,BRBMUMUmax,"BR(Bs -> mu+mu-)+Theor.Err."
      WRITE(17,902) 42,BRBMUMUmin,"BR(Bs -> mu+mu-)-Theor.Err."
      WRITE(17,899) 
     .   "# Exp. 2 Sigma: 8.90E-05 < BR(B+ > tau+ + nu_tau) < 2.45E-04:"
      WRITE(17,902) 5,BRBtaunu,"BR(B+ -> tau+ + nu_tau)"
      WRITE(17,902) 51,BRBtaunumax,
     .   "BR(B+ -> tau+ + nu_tau) + Theor.Err."
      WRITE(17,902) 52,BRBtaunumin,
     .   "BR(B+ -> tau+ + nu_tau) - Theor.Err."
      WRITE(17,899) "# BSM contr. to the muon anomalous magn. moment:"
      WRITE(17,902) 6,delmagmu,"Del_a_mu"
      WRITE(17,902) 61,amuthmax,"Del_a_mu + Theor.Err."
      WRITE(17,902) 62,amuthmin,"Del_a_mu - Theor.Err."
     ...
     .    " # (STOP/SBOTTOM MASSES)"
      ...
      WRITE(17,902) 1,DSQRT(G1S),"g1(Q,DR_bar)"
      WRITE(17,902) 2,DSQRT(G2S),"g2(Q,DR_bar)"
      WRITE(17,902) 3,DSQRT(G3S),"g3(Q,DR_bar)"
      ...
      WRITE(17,902) 1,PAR(20),"M1"
      WRITE(17,902) 2,PAR(21),"M2"
      WRITE(17,902) 3,PAR(22),"M3"
      WRITE(17,902) 21,MHDS,"M_HD^2"
      WRITE(17,902) 22,MHUS,"M_HU^2"
      WRITE(17,902) 31,DSQRT(PAR(18)),"M_eL"
      WRITE(17,902) 32,DSQRT(PAR(18)),"M_muL"
      WRITE(17,902) 33,DSQRT(PAR(10)),"M_tauL"
      WRITE(17,902) 34,DSQRT(PAR(19)),"M_eR"
      WRITE(17,902) 35,DSQRT(PAR(19)),"M_muR"
      WRITE(17,902) 36,DSQRT(PAR(11)),"M_tauR"
      WRITE(17,902) 41,DSQRT(PAR(15)),"M_q1L"
      WRITE(17,902) 42,DSQRT(PAR(15)),"M_q2L"
      WRITE(17,902) 43,DSQRT(PAR(7)),"M_q3L"
      WRITE(17,902) 44,DSQRT(PAR(16)),"M_uR"
      WRITE(17,902) 45,DSQRT(PAR(16)),"M_cR"
      WRITE(17,902) 46,DSQRT(PAR(8)),"M_tR"
      WRITE(17,902) 47,DSQRT(PAR(17)),"M_dR"
      WRITE(17,902) 48,DSQRT(PAR(17)),"M_sR"
      WRITE(17,902) 49,DSQRT(PAR(9)),"M_bR"      
      ...
      WRITE(17,902) 1,DSQRT(5d0/3d0*G1GUT),
     .        "g1(MGUT,DR_bar), GUT normalization"
      WRITE(17,902) 2,DSQRT(G2GUT),"g2(MGUT,DR_bar)"
      WRITE(17,902) 3,DSQRT(G3GUT),"g3(MGUT,DR_bar)"
     ...
     .        "HTAU(MGUT,DR_bar)"
      ...
      WRITE(17,902) 1,M1GUT,"M1"
      WRITE(17,902) 2,M2GUT,"M2"
      WRITE(17,902) 3,M3GUT,"M3"
      WRITE(17,902) 21,MHDGUT,"M_HD^2"
      WRITE(17,902) 22,MHUGUT,"M_HU^2"
      WRITE(17,902) 31,MLGUT,"M_eL^2"
      WRITE(17,902) 32,MLGUT,"M_muL^2"
      WRITE(17,902) 33,ML3GUT,"M_tauL^2"
      WRITE(17,902) 34,MEGUT,"M_eR^2"
      WRITE(17,902) 35,MEGUT,"M_muR^2"
      WRITE(17,902) 36,ME3GUT,"M_tauR^2"
      WRITE(17,902) 41,MQGUT,"M_q1L^2"
      WRITE(17,902) 42,MQGUT,"M_q2L^2"
      WRITE(17,902) 43,MQ3GUT,"M_q3L^2"
      WRITE(17,902) 44,MUGUT,"M_uR^2"
      WRITE(17,902) 45,MUGUT,"M_cR^2"
      WRITE(17,902) 46,MU3GUT,"M_tR^2"
      WRITE(17,902) 47,MDGUT,"M_dR^2"
      WRITE(17,902) 48,MDGUT,"M_sR^2"
      WRITE(17,902) 49,MD3GUT,"M_bR^2"
 ...
 2    WRITE(19,899) "# RELIC DENSITY CALCULATED BY MICROMEGAS"
     ...
     .      "# Unreliable Higgs widths in micrOMEGAs"
      ...
      ELSE
       ...
       WRITE(19,900) 4,"# Cannot compute Omega h^2 (IFAIL =/= 0,10)"
