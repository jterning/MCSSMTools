...
************************************************************************
      ...
      INTEGER NFAIL(NFL),IFAIL,I,OMGFLAG,MAFLAG
      INTEGER M1FLAG,M3FLAG,TOT,ITOT,NTOT,IDIM,IDUM,NMSFLAG,NMSCAN

      DOUBLE PRECISION PAR(NPAR),PROB(NPROB),RAN2,XDUM
...
*******************************************************************
      ...
      INTEGER M1FLAG,M3FLAG,NTOT,ISEED,NMSFLAG,NMSCAN
